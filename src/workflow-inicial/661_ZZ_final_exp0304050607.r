...
PARAM <- list()
PARAM$experimento <- "ZZ6610_exp0304050607"
PARAM$exp_input <- "HT6510_exp0304050607"
...
PARAM$semillas <- c(999959, 888887, 555557, 333337, 111119)
# Semilla Originales c(102191, 200177, 410551, 552581, 892237)
