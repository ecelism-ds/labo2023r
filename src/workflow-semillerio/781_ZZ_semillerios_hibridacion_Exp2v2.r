...
PARAM <- list()
PARAM$experimento <- "HB7810_001.Exp2v2"

# el inpput deben ser semillerios
PARAM$exp_input <- c("ZZ7710_exp02.1v2","ZZ7710_exp02.40","ZZ7710_exp02.66",
    "ZZ7710_exp02.20","ZZ7710_exp02.66x50","ZZ7710_exp02.25")
  # c("ZZ7710-01", "ZZ7710-66", "ZZ7710-53", "ZZ7710-52")
