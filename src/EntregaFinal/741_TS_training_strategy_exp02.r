...
PARAM <- list()
PARAM$experimento <- "TS7410_exp02"
...
PARAM$final_train <- c(
  ...
  202001, 202002, 202008, 202009, 202010, 202011, 202012,
...
PARAM$train$testing <- c(202102,202104,202106)
...
PARAM$train$semilla <- 888887
# 102191 # cambiar por su propia semilla  !!!
